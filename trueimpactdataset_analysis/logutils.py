...
class LogUtils(object):
    ...
    def how_often(total, update_freq=100):
        """
        Returns a number indicating after how many processed items should
        progress be printed
    ...
    def get_progress(processed, total):
        """
        Based on how many items were processed and how many items are there
        in total return string representing progress (e.g. "Progress: 54%")
